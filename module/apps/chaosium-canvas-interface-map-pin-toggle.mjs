...
export default class ChaosiumCanvasInterfaceMapPinToggle extends ChaosiumCanvasInterface {
  ...
  static defineSchema() {
    ...
    return {
      ...
      documentUuids: new fields.SetField(new fields.DocumentUUIDField(), {
      ...
      permissionShow: new fields.NumberField({
        choices: Object.keys(ChaosiumCanvasInterfaceMapPinToggle.PERMISSIONS).reduce((c, k) => {
          c[k] = game.i18n.localize(ChaosiumCanvasInterfaceMapPinToggle.PERMISSIONS[k]);
          return c;
        }, {}),
