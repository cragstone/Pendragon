...
export class PendragonNPCSheetv2 extends api.HandlebarsApplicationMixin(sheets.ActorSheetV2) {
  constructor(options = {}) {
    super(options);
  ...
  async _prepareItems(context) {
    ...
    context.gears = gears.sort(function (a, b) {
    ...
    context.talents = talents.sort(function (a, b) {
      return a.name.localeCompare(b.name);
    });
  ...
  _onRender(context, _options) {
    ...
    this.element
      ...
      .forEach((n) => n.addEventListener("dblclick", this._onItemDelete.bind(this)));
  }
